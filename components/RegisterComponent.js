...
const RegisterTextField = styled(InputBase)({
        ...
        <Box sx={{position:"relative",zIndex:"2",background:{md:"linear-gradient(to right, #fae1dd 0%, #ff99cc 100%)",sm:"linear-gradient(to bottom, #fae1dd 0%, #ff99cc 100%)",xs:"linear-gradient(to bottom, #fae1dd 0%, #ff99cc 100%)"},overflow: "hidden",padding:{sm:"0px",xs:"20px"}}}>
            <Grid container sx={{padding:{lg:"calc((100vh - 600px) / 2) calc((100vw - 1024px) / 2)",sm:"50px",xs:"0"},minHeight:"100vh"}}>
                <Grid order={{md:1,xs:2}} item md={6} xs={12} sm={12} sx={{border:"none",zIndex:"2",position:"relative",boxShadow:"0 12px 10px rgb(0 0 0 / 0.125)",borderRadius:"20px"}}>
                    ...
                    <img className={classes.banner} src={"/banner-wedding-2-text.png"}/>
                </Grid>
                    ...
                    <Box sx={{width:"100%",height:"100%"}}>
                        <Box sx={{width:"100%",height:"100%"}}>
                            ...
                            ,boxShadow:"0 2px 10px rgb(0 0 0 / 0.125)",padding:{sm:"20px 60px",xs:"20px"},textAlign:"center"}}>
                                ...
                                <RegisterTextField id="username" placeholder="Username" sx={{width:"100%",marginTop:"20px"}} variant="outlined" type="text"/>
                                <RegisterTextField id="email" placeholder="Email" sx={{width:"100%",marginTop:"20px"}} variant="outlined" type="email"/>
                                <RegisterTextField id="password" placeholder="Password" sx={{width:"100%",marginTop:"20px"}} variant="outlined" type="password"/>
                                <RegisterTextField id="password" placeholder="Confirm Password" sx={{width:"100%",marginTop:"20px"}} variant="outlined" type="password"/>
                                <RegisterButton variant="contained" sx={{marginTop:"20px",width:"100%",fontSize:"20px"}}>สร้างบัญชีผู้ใช้งาน</RegisterButton>
                                <Box sx={{textAlign:"right",marginTop:"10px"}}>
                                    
                                </Box>
                                <Typography variant="h6" sx={{fontSize:"20px",marginTop:"10px"}}></Typography>
                                <Box sx={{marginTop:"20px"}}>
                                    <Typography variant="a" sx={{color:"rgb(0 0 0 / 0.75)"}}>มีบัญชีผู้ใช้งานแล้ว ? </Typography>
